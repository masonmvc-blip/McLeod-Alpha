...
print('runtime_host_is_canonical:', status.get('runtime_host_is_canonical'))
print('canonical_runtime_host:', status.get('canonical_runtime_host'))
...
print('control_center_sha256:', fp.get('control_center_sha256'))
