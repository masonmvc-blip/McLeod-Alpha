...
## Executive Summary
Validation certification FAIL for system version v-cert-fail. Blocking failures: 1. Warnings: 0.

## Certification Status
- certification_id: VCERT-AF06655FDBADBCA21B03
- status: FAIL
- policy_version: 2026.07.v1
- system_version: v-cert-fail
...
## Lookahead Safety
- required_no_future_information: FAIL (Boolean requirement failed)

## Blocking Failures
- lookahead.safety: Boolean requirement failed

## Warnings
- None

## Required Remediation
- Resolve all blocking failures before extended paper trading.
...
- content_hash: c185057674824dff4110f557494934935fb986c19f095340a7c4b966b5d2d190
