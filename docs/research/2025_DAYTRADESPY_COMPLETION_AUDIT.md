...
- `data/research/daytradespy/records` contains 182 tracked machine records, including
  post-qualified filenames required to avoid silent duplicate-date
  overwrite.
- The registry contains 220 post-level reviews with evidence metadata: 212 Tier C
  transcript-based reviews and 8 Tier E access/content/duplicate gaps. Another 10
...
3. Resolve the remaining February and March post-level gaps in chronological
   order.
...
- Recording/publication date: February 18, 2025
- Post ID: `38596`
- Source:
  `https://daytradespy.com/38596/trading-room-video-recording-february-18-2025/`
