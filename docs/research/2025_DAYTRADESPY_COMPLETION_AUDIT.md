...
- `docs/research` contains 153 canonical dated 2025 daily-report filenames, plus one
  post-qualified June 27 duplicate-resolution report.
- `data/research/daytradespy/records` contains 98 machine records, including two
  post-qualified June 27 filenames required to avoid silent duplicate-date
  overwrite.
- The registry contains 139 post-level reviews with evidence metadata: 131 Tier C
  transcript-based reviews and 8 Tier E access/content/duplicate gaps. Another 91
...
- May 8, May 9, May 12-23, May 27-30, June 2, 3, 5, 9-11, 16-18, 23-27,
  ...
  August 26-29 and September 2-4 were
  upgraded from
...
3. Continue missing substantive post-level reports chronologically from September 5
   post `41518` through year-end.
...
- Recording/publication date: September 5, 2025
- Post ID: `41518`
- Source:
  `https://daytradespy.com/41518/trading-room-video-recording-september-5-2025/`
