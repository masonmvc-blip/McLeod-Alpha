...
- `docs/research` contains 156 canonical dated 2025 daily-report filenames, plus one
  post-qualified June 27 duplicate-resolution report.
- `data/research/daytradespy/records` contains 101 machine records, including two
  post-qualified June 27 filenames required to avoid silent duplicate-date
  overwrite.
- The registry contains 142 post-level reviews with evidence metadata: 134 Tier C
  transcript-based reviews and 8 Tier E access/content/duplicate gaps. Another 88
...
- May 8, May 9, May 12-23, May 27-30, June 2, 3, 5, 9-11, 16-18, 23-27,
  ...
  August 26-29 and September 2-9 were
  upgraded from
...
3. Continue missing substantive post-level reports chronologically from September 10
   post `41560` through year-end.
...
- Recording/publication date: September 10, 2025
- Post ID: `41560`
- Source:
  `https://daytradespy.com/41560/trading-room-video-recording-september-10-2025/`
