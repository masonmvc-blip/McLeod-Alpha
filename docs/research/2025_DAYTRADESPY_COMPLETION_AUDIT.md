...
- `docs/research` contains 214 canonical dated 2025 daily-report filenames, plus three
  post-qualified June 27, October 7, and October 14 lineage-resolution reports.
- `data/research/daytradespy/records` contains 164 tracked machine records, including
  post-qualified filenames required to avoid silent duplicate-date
  overwrite.
- The registry contains 202 post-level reviews with evidence metadata: 194 Tier C
  transcript-based reviews and 8 Tier E access/content/duplicate gaps. Another 28
...
- May 8, May 9, May 12-23, May 27-30, June 2, 3, 5, 9-11, 16-18, 23-27,
  ...
  August 26-29, September 2-30, October 1-31, November 3-28, and December 1-10 were
  upgraded from
...
3. Continue missing substantive post-level reports chronologically from December 11
   post `42660` through year-end.
...
- Recording/publication date: December 11, 2025
- Post ID: `42660`
- Source:
  `https://daytradespy.com/42660/trading-room-video-recording-december-11-2025/`
