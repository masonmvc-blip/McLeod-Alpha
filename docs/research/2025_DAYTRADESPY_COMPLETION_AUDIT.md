...
- `data/research/daytradespy/records` contains 185 tracked machine records, including
  post-qualified filenames required to avoid silent duplicate-date
  overwrite.
- The registry contains 223 post-level reviews with evidence metadata: 215 Tier C
  transcript-based reviews and 8 Tier E access/content/duplicate gaps. Another 7
...
- Recording/publication date: February 24, 2025
- Post ID: `38666`
- Source:
  `https://daytradespy.com/38666/trading-room-video-recording-february-24-2025/`
