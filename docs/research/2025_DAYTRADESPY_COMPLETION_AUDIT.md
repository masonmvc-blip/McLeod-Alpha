...
- `docs/research` contains 132 dated 2025 daily-report filenames, plus one
  post-qualified June 27 duplicate-resolution report.
- `data/research/daytradespy/records` contains 77 machine records, including two
  post-qualified June 27 filenames required to avoid silent duplicate-date
  overwrite.
- The registry contains 118 post-level reviews with evidence metadata: 110 Tier C
  transcript-based reviews and 8 Tier E access/content/duplicate gaps. Another 112
...
- May 8, May 9, May 12-23, May 27-30, June 2, 3, 5, 9-11, 16-18, 23-27,
  ...
  and July 28-31 were upgraded from
...
3. Continue missing substantive post-level reports chronologically from August 1
   post `41141` through year-end.
...
- Recording/publication date: August 1, 2025
- Post ID: `41141`
- Source:
  `https://daytradespy.com/41141/trading-room-video-recording-august-1-2025/`
