...
- `docs/research` contains 171 canonical dated 2025 daily-report filenames, plus one
  post-qualified June 27 duplicate-resolution report.
- `data/research/daytradespy/records` contains 116 tracked machine records, including two
  post-qualified June 27 filenames required to avoid silent duplicate-date
  overwrite.
- The registry contains 157 post-level reviews with evidence metadata: 149 Tier C
  transcript-based reviews and 8 Tier E access/content/duplicate gaps. Another 73
...
- May 8, May 9, May 12-23, May 27-30, June 2, 3, 5, 9-11, 16-18, 23-27,
  ...
  August 26-29, September 2-30, and October 1 were
  upgraded from
...
3. Continue missing substantive post-level reports chronologically from October 2
   post `41770` through year-end.
...
- Recording/publication date: October 2, 2025
- Post ID: `41770`
- Source:
  `https://daytradespy.com/41770/trading-room-video-recording-october-2-2025/`
